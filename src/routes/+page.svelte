<script>
  // Data untuk demo, bisa Anda sesuaikan
  let features = [
    {
      title: 'Fast and Responsive',
      description: 'Our platform is designed to be fast and fully responsive on all devices.',
      icon: '⚡'
    },
    {
      title: 'Secure',
      description: 'Your data is encrypted and kept safe with industry-leading security practices.',
      icon: '🔒'
    },
    {
      title: 'User Friendly',
      description: 'Intuitive UI for easy navigation and seamless experience.',
      icon: '👌'
    }
  ];
</script>
...
<main>
      ...
      <nav class="navbar fixed-top">
          <div class="container sm:px-4 lg:px-8 flex flex-wrap items-center justify-between lg:flex-nowrap">
              ...
              <a class="text-gray-800 font-semibold text-3xl leading-4 no-underline page-scroll" href="index.html">AKA-POS</a>
      ...
      <header id="header" class="header py-28 text-center md:pt-36 lg:text-left xl:pt-44 xl:pb-32">
          <div class="container px-4 sm:px-8 lg:grid lg:grid-cols-2 lg:gap-x-8">
              <div class="mb-16 lg:mt-32 xl:mt-40 xl:mr-12">
                  ...
                  <a class="btn-solid-lg secondary" href="/#"><i class="fab fa-google-play"></i>Download</a>
              </div>
      ...
      <div class="copyright">
          <div class="container px-4 sm:px-8 lg:grid lg:grid-cols-3">
              ...
              <p class="pb-2 p-small statement">Copyright © <a href="/#" class="no-underline">Your name</a></p>
